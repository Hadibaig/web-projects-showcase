...
This is intentionally a **simple, static app** — all analysis runs client-side in the browser. That means:
- Zero cost to host (GitHub Pages, Netlify, Vercel static, etc. all work)
